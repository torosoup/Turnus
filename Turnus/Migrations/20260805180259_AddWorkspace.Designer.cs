...
namespace Turnus.Migrations
{
    ...
    [Migration("20260805180259_AddWorkspace")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Turnus.Models.Workspace", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Turnus.Models.WorkspaceMember", b =>
                {
                    b.Property<int>("WorkspaceId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Turnus.Models.Availability", b =>
                {
                    ...
                    b.HasOne("Turnus.Models.Workspace", "Workspace")
                        .WithMany()
            ...
            modelBuilder.Entity("Turnus.Models.WorkspaceMember", b =>
                {
                    b.HasOne("Turnus.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
